    ...
    <section className='form'>
      <form onSubmit={onSubmit}>
        <div className="form-group">
          ...
          <input type="text" name='trackTitle' id='trackTitle' value={trackTitle} onChange={(e) => setTrackTitle(e.target.value)} />
          ...
          <input type="url" name='trackURL' id='trackURL' defaultValue={'http://'} onChange={(e) => setURL(e.target.value)} />
          <label htmlFor="deliveryDate">Delivery Date</label>
          <input type="datetime-local" name='deliveryDate' id='deliveryDate' min={minDate()} defaultValue={minDate()} onChange={(e) => setDeliveryDate(e.target.value)} />
        </div>
        <div className="form-group">
