...
const { loginUser, logoutUser, registerUser, checkRegisterEmail, forgotPassword, resetPassword, updateUser, getMe, emailData, checkUserToken, wakeDemoServer } = require('../controllers/userController')
